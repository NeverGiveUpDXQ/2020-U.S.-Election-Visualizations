...
We used three major datasets: the [2020 Presidential Election Results dataset](https://www.foxnews.com/elections/2020/general-results) from Fox News, as well as the Contribution Receipts dataset and the Campaign Disbursements dataset from FEC. We each were responsible for downloading one dataset from its data source. More details of the datasets are as following:
