...
**Dataset: RegisteredVotersByState.csv**

We collected the dataset from [*World Population Review*](https://worldpopulationreview.com/state-rankings/number-of-registered-voters-by-state). This dataset contains the registered voter count and percentage per state. The records are all updated after June, 2020.
...
The data records in this file were not all updated on the same day. No other known issues with this dataset. 
