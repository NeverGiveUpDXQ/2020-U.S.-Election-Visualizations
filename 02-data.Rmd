...
1. The election results data was collected on Nov.8, 2020, which the results do not reflect on the latest results. The election votes counting is continuing, so we don't get the final results yet. The latest data is not yet open to public.  
...
```{r, echo=FALSE, results='asis'}
knitr::kable(DataDescription[30:38, ], caption = "Major columns used",
             row.names = F,font_size = 10)
```
