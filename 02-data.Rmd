...
This project uses three major datasets. The primary data sources are [*Federal Election Commission*](http://fec.gov/data/) (FEC), [*The Cook Political Report*](https://cookpolitical.com/2020-national-popular-vote-tracker) (Cook Political) and [*Harvard Dataverse*](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/42MVDX).

FEC gathers and processes campaign finance data and discloses information about the public funding of US presidential elections. We downloaded the Contribution Receipts data and the Campaign Disbursement data from the FEC website. Cook Political collects and verifies US election returns across the country and is the authoritative source for 2020 Presidential Election voting results. And Harvard Dataverse provides U.S. state-level election results from 1976 to 2016.
...
DataDescription_add2<- readr::read_csv(here::here("./data/DatasetDescription_add2.csv"))
```
...
The election results data was collected on Dec.05, 2020, which the results do not reflect on the latest results. The election votes counting is continuing, so we don't get the final results yet. The latest data is not yet open to public.  
