...
In the project, we collected the voting data from [The Cook Political Report](https://cookpolitical.com/) as well as the presidential election committee contribution receipts and disbursements data from [Federal Election Commission](https://www.fec.gov/) to generate visualizations and conduct investigations on the relationships bwteen campaign finance and election results. We would like to carry out analysis from both geographic and time series perspectives and answer the following questions: 
