...
In the project, we collected the voting results data and historical election data from [*Harvard Dataverse*](https://dataverse.harvard.edu/), [The Cook Political Report](https://cookpolitical.com/), and [FOX News](https://www.foxnews.com/), as well as the presidential election committee contribution receipts and disbursements data from [Federal Election Commission](https://www.fec.gov/) to generate visualizations and conduct investigations on the relationships between campaign finance and election results. We would like to carry out analysis from both geographic and time series perspectives and answer the following questions: 
