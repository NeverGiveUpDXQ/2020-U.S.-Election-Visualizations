...
In the project, we collected the voting data from [*Harvard Dataverse*](https://dataverse.harvard.edu/), [The Cook Political Report](https://cookpolitical.com/), [FOX News](https://www.foxnews.com/) as well as the presidential election committee contribution receipts and disbursements data from [Federal Election Commission](https://www.fec.gov/) to generate visualizations and conduct investigations on the relationships between campaign finance and election results. We would like to carry out analysis from both geographic and time series perspectives and answer the following questions: 

- Is there anything surprising about the 2020 U.S. Presidential Election results?
- How much has presidential election committees raised and spent this year?
