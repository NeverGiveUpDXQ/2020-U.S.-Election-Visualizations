...
The election voting results and the disbursements datasets do not have missing values, however, the contribution receipts dataset have 275 values missed in some columns.
