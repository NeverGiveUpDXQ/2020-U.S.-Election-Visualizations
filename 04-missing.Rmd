...
The historical and current election voting outcome and the disbursements datasets do not have missing values, however, the contribution receipts dataset has 275 values missed in some columns.
...
m1<- gg_miss_upset(contribution_processed)
m1
```
